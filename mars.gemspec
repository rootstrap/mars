...
Gem::Specification.new do |spec|
  ...
  spec.email = ["sbartesaghi@hotmail.com", "andres@rootstrap.com", "ignacio.perez@rootstrap.com", "santiago.diaz@rootstrap.com"]

  spec.summary = "Multi-Agent Ruby SDK - A framework for building multi-agent solutions in pure Ruby"
  spec.description = "MARS (Multi-Agent Ruby SDK) provides a comprehensive framework for developers to implement multi-agent solutions using pure Ruby. It offers a simple API for orchestrating multiple agents."
